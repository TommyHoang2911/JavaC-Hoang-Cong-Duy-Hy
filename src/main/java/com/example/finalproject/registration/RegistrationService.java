...
import com.example.finalproject.appuser.AppUserRole;
import com.example.finalproject.appuser.AppUserService;
import com.example.finalproject.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = "https://notewebfinaltest.herokuapp.com/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
